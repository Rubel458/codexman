...
export const adminResources = {
  ...
  "download-items": { label: "Download Files", delegate: () => prisma.downloadItem, allowed: ["slug", "title", "description", "additionalInfo", "thumbnailUrl", "fileName", "originalFilename", "fileMimeType", "fileSizeBytes", "livePreviewUrl", "downloadCount", "published", "sortOrder", "categoryId"] },
  "download-categories": { label: "Download Categories", delegate: () => prisma.downloadCategory, allowed: ["name", "slug"] },
  "gallery-items": { label: "Gallery", delegate: () => prisma.galleryItem, allowed: ["title", "imageUrl", "altText", "sortOrder", "published"] },
  "blog-posts": { label: "Blog Posts", delegate: () => prisma.blogPost, allowed: ["slug", "title", "excerpt", "featuredImageUrl", "content", "publishedAt", "published", "sortOrder", "categoryId"] },
  "blog-categories": { label: "Blog Categories", delegate: () => prisma.blogCategory, allowed: ["name", "slug"] },
  "promo-banners": { label: "Sidebar Promotional Banners", delegate: () => prisma.promoBanner, allowed: ["location", "title", "imageUrl", "targetUrl", "published", "sortOrder"] },
